...
* Index.clean() now throws InterruptedException instead of swallowing it.
  Additionally the timeout parameter is obeyed more accurately.
    - Since InterruptedException is a checked exception, callers must now
      handle it.
