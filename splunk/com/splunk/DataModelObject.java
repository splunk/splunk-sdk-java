...
public class DataModelObject {
    ...
    private Map<String, Field> autoextractedFields;
    private Collection<Constraint> constraints;
    private Map<String, Calculation> calculations;

    DataModelObject(DataModel model) {
        this.model = model;
        this.autoextractedFields = new HashMap<String, Field>();
    ...
    public boolean containsField(String fieldName) {
        ...
        for (Calculation c : calculations.values()) {
     ...
     */
    public Collection<Field> getAutoExtractedFields() {
        return autoextractedFields.values();
    }
